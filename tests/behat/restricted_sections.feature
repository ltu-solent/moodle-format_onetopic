...
Feature: Only the first n sections can be deleted or moved
  ...
  Scenario: First two sections are locked for a course in modules_ category
    ...
    Then I should see "Edit settings" in the ".section_action_menu" "css_element"
    And I should not see "Delete" in the ".section_action_menu" "css_element"
    And I should not see "Move" in the ".section_action_menu" "css_element"
    ...
    When I open the action menu in ".section_action_menu" "css_element"
    Then I should see "Edit settings" in the ".section_action_menu" "css_element"
    And I should see "Delete" in the ".section_action_menu" "css_element"
    And I should see "Move" in the ".section_action_menu" "css_element"
